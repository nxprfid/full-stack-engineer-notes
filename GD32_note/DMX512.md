...
2. [CSDN](https://blog.csdn.net/weixin_63723467/article/details/145046968)  
3. [CSDN2](https://blog.csdn.net/weixin_43870206/article/details/107692446)  
3. [百度百科](https://baike.baidu.com/item/DMX512/2904121)  
# DMX512
...
DMX512代表每一包的数据有512帧。（已发送 513 个，但未使用第一个）标准最多 32 个设备。   
...
### 实际应用示例  
假设你要控制 **RGB 灯带（c=3 通道）**，且 **每段灯带含 5 个像素（P=5）**：  
代入公式得 `n ≤ 512 / (3×5) ≈ 34.13` → 实际最多带 34 段灯带（通道数不能超 512 ）。  
