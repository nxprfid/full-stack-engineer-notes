...
- **智能家居照明**：客厅、卧室、厨房等场景照明控制
- **商业照明**：办公室、商店、展厅的智能照明系统
- **景观照明**：公园、广场等户外装饰照明
- **工业照明**：工厂、仓库等工业环境照明控制

### 📋 **技术规格**

- **处理器**：ARM Cortex-M0，支持BLE 5.1
- **内存**：RAM 64KB，Flash 512KB
- **工作电压**：1.8V-3.6V
- **工作温度**：-40°C至+85°C
- **通信距离**：室内10-30米，室外可达100米
- **网络容量**：支持数千个节点的大型Mesh网络

这个工程提供了一个完整的BLE Mesh智能灯光解决方案，具备工业级的稳定性和丰富的功能特性，适合各种智能照明应用场景的开发和部署。
